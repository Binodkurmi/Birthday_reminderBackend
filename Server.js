...
// ✅ Serve static files ONLY from uploads directory (no subfolders)
app.use('/uploads', express.static(path.join(__dirname, 'uploads')));

// ✅ ADD: Debug route to list uploads folder
...
.then(() => {
  ...
  // Start birthday notification scheduler AFTER successful DB connection
